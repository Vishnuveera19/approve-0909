...
import leaveapprove from "./components/leaveapproveform";
import Leaveapprovenew0909 from "./components/leaveapproveform";
import LeaveApproveTable09 from "./components/leaveapprovetable";
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<App />}>
          ...
          <Route path="/home" element={<ServiceCard />}></Route>n
        ...
        <Route path="/asasas" element={<Leaveapprovenew0909/>}></Route>
        <Route path="LeaveApproveTable09" element={<LeaveApproveTable09/>}></Route>
        </Route>
      </Routes>
    </BrowserRouter>
  </Provider>
